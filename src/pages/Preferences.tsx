        ...
        <div className="container flex gap-2 pb-3">
          {STEPS.map((s, i) => (
            <div key={s} className="flex flex-1 flex-col items-center gap-1">
              <div
                className={`h-1 w-full rounded-full transition-colors ${i <= step ? "bg-primary" : "bg-muted"}`}
              />
              <span
                ...
                {categories.map((c) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`flex h-14 w-14 items-center justify-center rounded-full text-3xl ${selected ? "bg-primary/10" : "bg-muted"}`}
                      >
                        {c.icon}
                      </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4 md:grid-cols-3">
                {STYLES.map((s) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`flex h-14 w-14 items-center justify-center rounded-full ${selected ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"}`}
                      >
              ...
              <div className="mt-6 grid grid-cols-2 gap-4 md:grid-cols-4">
                {FITS.map((fit) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`flex h-16 items-center justify-center text-4xl ${selected ? "text-primary" : "text-muted-foreground"}`}
                      >
                        {fit.id === "slim" && "╏"}
                        {fit.id === "regular" && "▯"}
                        {fit.id === "relaxed" && "▭"}
