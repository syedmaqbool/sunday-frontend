...
const MOCK_CATEGORIES: Category[] = [
  { id: "mock-cat-1", label: "Women",    value: "women",    icon: "👗", sort_order: 1 },
  { id: "mock-cat-2", label: "Men",      value: "men",      icon: "👔", sort_order: 2 },
  { id: "mock-cat-3", label: "Children", value: "children", icon: "🧸", sort_order: 3 },
];

const MOCK_SUBCATEGORIES: Subcategory[] = [
  { id: "mock-sub-1", label: "Tops",     value: "tops",     icon: "👕", sort_order: 1 },
  { id: "mock-sub-2", label: "Bottoms",  value: "bottoms",  icon: "👖", sort_order: 2 },
  { id: "mock-sub-3", label: "Dresses",  value: "dresses",  icon: "👗", sort_order: 3 },
  { id: "mock-sub-4", label: "Shoes",    value: "shoes",    icon: "👟", sort_order: 4 },
  { id: "mock-sub-5", label: "Jackets",  value: "jackets",  icon: "🧥", sort_order: 5 },
];
