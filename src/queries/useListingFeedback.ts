...
export const listingFeedbackQueryKey = {
  list: (listingId?: string) => ['listing-feedback', listingId] as const,
};

export function getListingFeedbackOptions(listingId: string | undefined) {
  return queryOptions({
    enabled: !!listingId,
    queryFn: async () => {
    ...
    queryKey: listingFeedbackQueryKey.list(listingId),
  });
}
