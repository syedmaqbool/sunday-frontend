      ...
      <main className="container flex-1 py-12">
        ...
        <article className="mx-auto max-w-3xl">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-2 text-sm leading-relaxed text-muted-foreground">
              ...
              <ul className="list-disc space-y-1 pl-5">
                ...
                <li>
                  Items comply with applicable laws and do not infringe rights
                </li>
              </ul>
              <p>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-2 text-sm leading-relaxed text-muted-foreground">
              <p>
                <strong>6.1 Bidding, Offer and Acceptance</strong>
              </p>
              <p>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-2 text-sm leading-relaxed text-muted-foreground">
              <p>
                <strong>7.1 Seller Responsibility</strong>
              </p>
              <p>
                Sellers are solely responsible for arranging and completing
                shipment of sold items. Sellers are recommended to take the
                following measures to ensure safe delivery:
              </p>
              <ul className="list-disc space-y-1 pl-5">
              ...
              <p>
                <strong>7.2 Approved Shipping Providers</strong>
              </p>
              <p>
                Sunday may restrict shipping to selected courier partners
                integrated within the Platform to standardize tracking and
                reduce risk. Users agree to use only such approved providers
                where applicable.
              </p>
              <p>
                <strong>7.3 Shipment Timeline</strong>
              </p>
              <p>
                Sellers must dispatch the order and upload valid tracking
                details within forty-eight (48) hours of order confirmation.
              ...
              <p>
                <strong>7.4 Delivery and Tracking</strong>
              </p>
              <p>
                Buyers must confirm receipt upon delivery. If no confirmation is
                provided:
              </p>
              <ul className="list-disc space-y-1 pl-5">
                ...
                <li>
                  Order status may be updated based on available information
                </li>
              </ul>
              <p>
                <strong>7.5 Lost Shipments</strong>
              </p>
              <p>
                A shipment will only be considered lost if confirmed by the
                courier. If a shipment is confirmed lost through the courier,
                the buyer will be refunded.
              </p>
              <p>
                <strong>7.6 Limitation of Responsibility</strong>
              </p>
              <p>
                Sunday does not provide logistics services and is not
                responsible for delays, loss, damage, or non-delivery of items.
                All shipment-related processes implemented by Sunday are risk
                mitigation and user protection measures only and do not imply
                liability or guarantee delivery outcomes.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            <h2 className="mb-3 font-heading text-xl font-semibold">
              8. Quality Verification and Order Completion
            </h2>
            <div className="space-y-2 text-sm leading-relaxed text-muted-foreground">
              <p>
          ...
          <section className="mb-8">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-relaxed text-muted-foreground">
              ...
              <li>
                Attempting to use information from other accounts for any
                purpose prohibited by the platform
              </li>
            </ul>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="mb-8">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              All platform content is owned by or licensed to Sunday and may not
          ...
          <section className="mb-8">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              To the maximum extent permitted by law, Sunday shall not be liable
              for:
            </p>
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-relaxed text-muted-foreground">
              <li>User disputes</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              You agree to indemnify and hold Sunday harmless from any claims
              arising from your use of the Platform, violation of these Terms,
              or breach of applicable laws.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Sunday reserves the right to suspend or terminate accounts that
              violate these Terms or pose risk to the Platform.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              These Terms shall be governed by the laws of the Islamic Republic
              of Pakistan.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Sunday may update these Terms at any time. Continued use
