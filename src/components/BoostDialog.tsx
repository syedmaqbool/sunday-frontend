...
const BoostDialog = ({ listingId, listingTitle, trigger }: Props) => {
  ...
  const cpm = budget > 0 && estImpressions > 0 ? (budget / estImpressions) * 1000 : 0;
  ...
  const grouped = useMemo(() => {
    const g: Record<BoostPlacement, BoostPackage[]> = { trending: [], for_you: [], search: [] };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Run a custom campaign with your own budget and dates, or pick a ready-made package.
          </DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="campaign" className="space-y-5 pt-4">
              ...
              >
                {(Object.keys(placementMeta) as BoostPlacement[]).filter((p) => p !== "trending").map((p) => {
                  ...
                  return (
                    ...
                    >
                      <RadioGroupItem id={`pl-${p}`} value={p} className="sr-only" />
            ...
            <div className="space-y-2">
              ...
              >
                ...
                >
                  <RadioGroupItem id="g-imp" value="impressions" className="sr-only" />
                ...
                >
                  <RadioGroupItem id="g-clk" value="clicks" className="sr-only" />
            ...
            <Card className="bg-muted/30 p-4">
              ...
              <p className="mt-3 text-[11px] text-muted-foreground">
                Estimates based on recent {placementMeta[placement].label} performance.
              </p>
            </Card>
