...
const MOCK_FAQS: Faq[] = [
  {
    ...
    answer: "Click on 'Create Listing' in the navbar, fill in your item details, upload photos, set a price, and hit publish. Your item will be live instantly.",
  },
  {
    id: "faq-2",
    question: "How does payment work?",
    answer: "We use secure payment processing. Buyers pay at checkout, and sellers receive their payout once the buyer confirms delivery.",
  },
  {
    id: "faq-3",
    question: "What is your return policy?",
    answer: "Buyers have 12 hours after delivery to raise a quality concern. If the item doesn't match the listing, we'll help resolve it.",
  },
  {
    id: "faq-4",
    question: "How do I ship my sold item?",
    answer: "Once your item sells, go to your profile under 'Sold' and mark it as shipped with a tracking number. We support PostNet, Aramex, DHL, and more.",
  },
  {
    id: "faq-5",
    question: "Can I make an offer on a listing?",
    answer: "Yes! On any listing page, click 'Make Offer' and enter your price. The seller will accept, decline, or counter your offer.",
  },
];
